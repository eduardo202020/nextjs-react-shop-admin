...
export default function Dashboard() {
  ...
  // obtenemos los productos y total de items
      ...
      <div className="flex flex-col">
        <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          ...
          >
            ...
            >
              <Pagination className="px-0" setOffset={setOffset} productNumberLimit={PRODUCT_LIMIT} totalItems={totalItems} />
              <table id="tabla" className="min-w-full divide-y divide-gray-200">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <Image width="40px" height="40px" className="h-10 w-10 rounded-full" src={product.images[0]} alt="" />
                          </div>
                          <div className="ml-4">
                            <div
